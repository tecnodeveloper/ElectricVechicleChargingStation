...
<head>
    ...
    <title>Sign Up - EVC</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script src="https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js" defer></script>
</head>
<body class="bg-slate-900 text-white min-h-screen flex items-center justify-center py-8">
    <div class="w-full max-w-md mx-auto p-6">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 text-sm">Join the future of electric vehicle charging</p>
        </div>
            ...
            <form action="{{ route('register.submit') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ showConfirmPassword: false }">
                        ...
                        <button
                            ...
                            <svg x-show="showConfirmPassword" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style="display: none;">
                                <path fill-rule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.074l-1.78-1.781zm4.261 4.26l1.514 1.515a2.003 2.003 0 012.45 2.45l1.514 1.514a4 4 0 00-5.478-5.478z"/>
                                <path d="M12.454 16.697L9.75 13.992a4 4 0 01-3.742-3.741L2.335 6.578A9.98 9.98 0 00.458 10c1.274 4.057 5.065 7 9.542 7 .847 0 1.669-.105 2.454-.303z"/>
                            </svg>
                        </button>
                ...
                <div class="flex items-start">
                    <input
                        ...
                        type="checkbox"
                        required
                        class="w-4 h-4 text-green-600 bg-slate-700 border-slate-600 rounded focus:ring-green-500 focus:ring-2 mt-0.5">
                ...
                <button
                    type="submit"
                    class="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-slate-800 mt-6">
                    Create Account
                </button>
            </form>
